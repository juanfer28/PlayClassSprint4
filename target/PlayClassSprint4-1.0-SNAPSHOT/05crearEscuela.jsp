<%-- 
    Document   : 05crearEscuela
    Created on : 20/09/2021, 8:37:19 p. m.
    Author     : Juanfer
--%>
...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 1080px; height:60px; ">
    <header class="site-header sticky-top py-1">
        <nav class="container d-flex flex-column flex-md-row justify-content-between">
          ...
          <label class="py-2 d-none d-md-inline-block text-primary" >Crear Escuela</label>
          <a class="py-2 d-none d-md-inline-block" href="#">Borrar Escuela</a>
          <a class="py-2 d-none d-md-inline-block" href="#">Modificar Escuela</a>
  ...
  <div class="container mt-5"> 
    <h3 class="mb-3">Crear Escuela</h3>
    <hr>
