    ...
    <body class="text-center">
        <div class="px-4 py-5 my-5 text-center">
            ...
            <div class="col-lg-6 mx-auto">
                ...
                <form action="06registrarEstudiante.jsp?nombreCompletotxt=<%= nombre %>" >
                    <input type="hidden" name = nombreCompletotxt value = "<%= nombre %>">
                    ...
                    <div class="form-floating mt-4 mb-4">
                        <input type="nombre" class="form-control" id="nombreAcademia" placeholder="nombreAcademia">
                        <label for="nombreAcademia">URL de la Foto</label>
                    </div>
                    </div>
