        ...
        <main class="form-signin">
            <form action="03bienvenida.jsp">
                ...
                <div class="form-floating mb-3">
                    <input type="nombre" class="form-control" id="nombretxt" name ="nombretxt" value ="" placeholder="juan fernando" required>
                ...
                <div class="form-floating mb-3">
                    <input type="password" class="form-control" id="contrasena2" placeholder="Password" required>
                    <label for="contrasena2">Confirmar Contraseña</label>
                </div>
                <div class="checkbox mb-3">
                    <label>
                        <input type="checkbox" value="remember-me" required> Acepto  <a href="#" class="link-primary"> Términos de Servicio</a> y <a href="#" class="link-primary">Políticas de privacidad</a>
                    </label>
                </div>
                </div>
                <button class="w-100 btn btn-lg btn-primary" type="submit">Crear Cuenta</button>
                <a href="01login.jsp"><button type="button" class="mt-3 mb-1 w-70 btn btn-outline-secondary">Volver a iniciar Sesión</button>
