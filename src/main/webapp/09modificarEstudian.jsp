<%-- 
    Document   : 06_2modificarEstudian
    Created on : 30/09/2021, 7:31:19 p. m.
    Author     : SIRIUS
--%>
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <symbol id="geo-fill" viewBox="0 0 16 16">
   ...
   <symbol id="modulos" viewBox="0 0 16 16">
...
<main>
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
      <img class="bi me-2" src="logoPlayClass.png" alt="" width="40" height="40">  
      <span class="fs-3 fw-bold">PlayClass</span>
    </a>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="#" class="nav-link link-dark">
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#modulos"/></svg>
          Modulos
        </a>
      </li>
      <li>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light " style="width: 1080px; height:60px; ">
    <header class="site-header sticky-top py-0 bg-light pb-2">
        <nav class="container d-flex flex-column flex-md-row justify-content-between">
          ...
          <a class="py-2 d-none d-md-inline-block" href="#">Crear Estudiante</a>
          <a class="py-2 d-none d-md-inline-block" href="#">Borrar Estudiante</a>
          <label class="py-2 d-none d-md-inline-block text-primary" >Modificar Estudiante</label>
      ...
      <div class="container mt-5"> 
        <h3 class="mb-3">Modificar Estudiante</h3>
        <hr>
        <form method="post" action="juguetes_ctrl.jsp">
            ...
            <div class="row mb-3">
             ...
             <div class="row mb-3">
                ...
                <input type="text" class="col-form-control col-sm-10" id="txtApellido" name="txtApellido" value="">
            </div>
           <div class="row mb-3">
                <label for="txtNombre" class="col-form-label col-sm-2">E-mail</label>
                <input type="text" class="col-form-control col-sm-10" id="txtEmail" name="txtEmail" value="">
            </div>
           <div class="row mb-3">
                <label for="txtNombre" class="col-form-label col-sm-2">Teléfono</label>
                <input type="text" class="col-form-control col-sm-10" id="txtTelefono" name="txtTelefono" value="">
            </div>
    <div class="row mb-3">
                <label for="selTipo" class="col-form-label col-sm-2">Nombre del Curso</label>
                <select class="col-form-control col-sm-10" id="selCurso" name="selCurso">
            <option selected value=""></option>
                    <option value="Matematicas">Matemáticas</option>
            <option value="Lenguaje">Idiomas</option>
