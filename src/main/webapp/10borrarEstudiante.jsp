<%-- 
    Document   : 06_3borrarEstudiante
    Created on : 30/09/2021, 7:34:36 p. m.
    Author     : SIRIUS
--%>
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light " style="width: 1080px; height:60px; ">
            <header class="site-header sticky-top py-0 bg-light pb-2">
                <nav class="container d-flex flex-column flex-md-row justify-content-between">
                    ...
                    <label class="py-2 d-none d-md-inline-block text-primary" >Borrar Estudiante</label>
            ...
            <div class=" mt-3 alert alert-warning d-flex align-items-center" role="alert">
                ...
                <div>
                    <strong>¡Cuidado!</strong> Al borrar al estudiante no lo podra recuperar.
                </div>
            </div>
            <div class="container mt-2"> 
                <h3 class="mb-3">Borrar Estudiante</h3>
                <hr>
                <%
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="borrarControl.jsp?accion=borrar&id=<%= e.getId()%>"><button type="button" class=" btn btn-danger"><i class="bi bi-trash"></i></button></a>
