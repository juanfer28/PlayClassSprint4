<%-- 
    Document   : 06_1crearEstudiante
    Created on : 30/09/2021, 7:27:52 p. m.
    Author     : SIRIUS
--%>
            ...
            <div class="container mt-5"> 
                ...
                <%
                    ...
                    if (accion.equals("editar")) {
                        ...
                        Estudiante e = logicaEstudiantes.cargarUnEstudiante(id);
                        nombre = e.getNombre();
                        apellido = e.getApellido();
                        email = e.getEmail();
                        telefono = e.getTelefono();
                        fecha = e.getFechaInicio();
                        curso = e.getIdcurso();
                    } else {
                        id = 0;
                    }
                ...
                <form method="post" action="estudiantes_ctrl.jsp">
                    ...
                    <div class="row mb-3">
                        ...
                        <input type="text" class="col-form-control col-sm-10" id="txtApellido" name="txtApellido" value="<%= apellido %>">
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <select class="col-form-control col-sm-10" id="selCurso" name="selCurso">
                            ...
                            <% for (Map.Entry<Integer, String> entrada : cursos.entrySet()) {%>
                            <option <%= entrada.getKey() == curso ? "selected" : ""%> value="<%= entrada.getKey()%>"><%= entrada.getValue()%></option>
                            <% }%>
                        </select>
                    </div>
                    <div class="row mb-3">
